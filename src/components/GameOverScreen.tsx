        ...
        <div className="space-y-6">
          <div className="bg-primary/20 rounded-lg p-6 space-y-4">
            ...
            <div className="flex items-center justify-center gap-4">
              <Badge
                variant="outline"
                className={`text-2xl px-4 py-2 border-2 ${getScoreColor()}`}
              >
          ...
          <div className="grid grid-cols-1 gap-4">
            <div className="text-sm text-muted-foreground space-y-2">
              <p>
                💡 <strong>Pro Tip:</strong> Practice more to improve your math
                skills!
              </p>
              {score < totalQuestions && (
                <p>
                  🎯 You were just {totalQuestions - score} question
                  {totalQuestions - score !== 1 ? "s" : ""} away from victory!
                </p>
              )}
            </div>
          </div>
